    ...
    >
      <div className="relative w-full h-full">
        ...
        >
          ...
          hoodies <br />
          <br />
          <Link href="#" className="text-black bg-white text-sm font-light rounded-3xl p-3">shop now</Link>
        </span>
      </div>
      <div className="relative w-full h-full">
        <Image
        ...
        <span className="absolute z-50 top-1/3 md:text-7xl text-4xl  left-10 md:left-20 text-white font-bold">
          ...
          hoodies{" "}
          <br />
          <Link href="#" className="text-black bg-white text-sm font-light rounded-3xl p-3">shop now</Link>        </span>
      </div>
      <div className="relative w-full h-full">
        <Image
          className="w-full  h-full md:h-auto object-cover md:object-contain object-center"
